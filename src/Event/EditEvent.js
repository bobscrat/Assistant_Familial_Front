...
import'./event.css';
import Modal1Edit from './Modal1Edit.js';
import Modal2Edit from './Modal2Edit.js';
import Modal3Edit from './Modal3Edit.js';
import Modal4Edit from './Modal4Edit.js';
import Modal5Edit from './Modal5Edit.js';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Popup trigger={<Icon link name='pencil' color='orange' size='large' onClick={this.show(true)}/>}>
          <Popup.Header>Modifier cet événement</Popup.Header>
          <Popup.Content>
            En cliquant sur ce bouton, vous modifier cet événement.
          </Popup.Content>
        </Popup>
        <Modal 
          dimmer={dimmer} 
        ...
        >          
            ...
            <Modal.Content>            
              <Modal.Description>
                {this.state.showModal[0] && < Modal1Edit 
                ...
                />}
                {this.state.showModal[1] && < Modal2Edit 
                ...
                />}
                {this.state.showModal[2] && < Modal3Edit 
                ...
                />}
                {this.state.showModal[3] && < Modal4Edit 
                ...
                />}
                {this.state.showModal[4] && < Modal5Edit 
